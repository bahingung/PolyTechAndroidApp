...
class ContactFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val addr = LatLng(18.813722, 98.992220)
        mMap.addMarker(MarkerOptions().position(addr).title("ที่ทำงาน"))
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(addr, 16.0f));
    }
